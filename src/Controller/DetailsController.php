...
class DetailsController extends AppController
{
    ...
    public function add()
    {
        ...
        $families = $this->Details->Families->find('list', ['limit' => 200]);
        $persons = $this->Details->Persons->find('list', ['limit' => 200]);
        $this->set(compact('detail', 'families', 'persons'));
    }
